...
function forzarActualizacionCache() {
    var recursos = [
        'estilos/normalize.css?v2s',
        'estilos/styles.css?v2s',
        'estilos/mediaQueries.css?v2s',
        'javascript/script.js?v2s',
        // Add other URLs of your resources here
    ];
    var version = 'v2s'; // Use a static or manually managed version
