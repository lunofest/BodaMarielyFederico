...
function updateTimer() {
    const targetDate = new Date("February 15, 2025 22:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const recipientNumber1 = '543814173019'; // Número para el primer botón
    const recipientNumber2 = '543874882992'; // Número para el segundo botón
...
document.addEventListener('DOMContentLoaded', function() {
    // Definir los números de teléfono
    const phoneNumber1 = '543885813562'; // Número para el primer botón
